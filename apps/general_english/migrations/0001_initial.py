    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('module', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='reading', to='general_english.module', verbose_name='Қай модульге тиесілі')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('question', models.TextField(help_text='Оқу сұрағының толық мәтіні', verbose_name='Сұрақ мәтіні')),
                ('reading', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reading_questions', to='general_english.reading')),
            ],
        ),
        migrations.CreateModel(
            name='ReadingOption',
